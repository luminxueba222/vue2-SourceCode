<template>
  <div id="flowChart">
    ...
    <div class="info">
      ...
      <div class="content">
        <el-checkbox v-if="isBlank === true"
                     v-model="checked">网格对齐</el-checkbox>
        <el-form v-else
                 label-position="left"
                 label-width="60px">
          <el-form-item v-if="isNode !== true"
                        label="动作">
          ...
          <el-form-item v-if="isNode === true"
                        label="流图">
            <el-select v-model="workflow"
                       size="mini"
                       filterable
                       clearable
                       placeholder="绑定流图"
                       value="">
              <el-option v-for="item in workflowList"
                         :key="item.id"
                         :label="item.label"
                         :value="item.id">
              </el-option>
